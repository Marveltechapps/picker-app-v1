      ...
      <View style={styles.mapBackground}>
        ...
        <View style={styles.locationMarker}>
          ...
          <View style={styles.locationLabel}>
            <Text style={styles.locationText}>Padur • 2.3km</Text>
          </View>
        </View>
      </View>
      ...
      >
        ...
        <View style={styles.nearestCard}>
          ...
          <View style={styles.nearestInfo}>
            ...
            <Text style={styles.nearestLocation}>Padur Darkstore • 2.3km away</Text>
          </View>
          <View style={styles.travelInfo}>
            <Text style={styles.travelLabel}>Est. Travel</Text>
            <Text style={styles.travelTime}>8 min</Text>
          </View>
        </View>
