...
export default function AttendanceScreen() {
  ...
  const getShiftTimes = () => {
    if (selectedShifts.length > 0) {
      const shiftTime = selectedShifts[0].time;
  ...
  const calculateOTEarnings = (hours: number): number => {
    return Math.round(calculateOvertimePay(hours));
  };

  const otData: OTMonthData = {
    "January-2026": [
      { week: "Week 1", dateRange: "Jan 1-7", hours: 1.5, earnings: calculateOTEarnings(1.5) },
      { week: "Week 2", dateRange: "Jan 8-14", hours: 3, earnings: calculateOTEarnings(3) },
      { week: "Week 3", dateRange: "Jan 15-21", hours: 2.5, earnings: calculateOTEarnings(2.5) },
      { week: "Week 4", dateRange: "Jan 22-28", hours: 1, earnings: calculateOTEarnings(1) },
    ],
    "October-2025": [],
  };

  const historyData: HistoryData = {
    "2024-01-01": { punchIn: "9:15 AM", punchOut: "6:20 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 52, incentive: 420, overtime: null, status: "present" },
    "2024-01-02": { punchIn: "9:20 AM", punchOut: "6:15 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 48, incentive: 380, overtime: null, status: "present" },
    "2024-01-03": { punchIn: "9:10 AM", punchOut: "6:25 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 56, incentive: 460, overtime: null, status: "present" },
    "2024-01-04": { punchIn: "9:25 AM", punchOut: "6:10 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 50, incentive: 400, overtime: null, status: "present" },
    "2024-01-05": { punchIn: "9:05 AM", punchOut: "8:15 PM", totalHours: 11, warehouse: "Downtown Hub", orders: 62, incentive: 520, overtime: 2, status: "present" },
    "2024-01-08": { punchIn: "9:18 AM", punchOut: "6:22 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 51, incentive: 410, overtime: null, status: "present" },
    "2024-01-09": { punchIn: "9:12 AM", punchOut: "6:18 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 49, incentive: 390, overtime: null, status: "present" },
    "2024-01-10": { punchIn: "9:22 AM", punchOut: "2:30 PM", totalHours: 5, warehouse: "Downtown Hub", orders: 28, incentive: 200, overtime: null, status: "half-day" },
    "2024-01-11": { punchIn: "9:08 AM", punchOut: "6:12 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 53, incentive: 430, overtime: null, status: "present" },
    "2024-01-12": { punchIn: "9:15 AM", punchOut: "8:20 PM", totalHours: 11, warehouse: "Downtown Hub", orders: 64, incentive: 540, overtime: 2, status: "present" },
    "2024-01-15": { punchIn: "9:20 AM", punchOut: "6:25 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 50, incentive: 400, overtime: null, status: "present" },
    "2024-01-17": { punchIn: "9:10 AM", punchOut: "6:15 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 52, incentive: 420, overtime: null, status: "present" },
    "2024-01-18": { punchIn: "9:15 AM", punchOut: "8:25 PM", totalHours: 11, warehouse: "Downtown Hub", orders: 66, incentive: 560, overtime: 2, status: "present" },
    "2024-01-19": { punchIn: "9:12 AM", punchOut: "8:18 PM", totalHours: 11, warehouse: "Downtown Hub", orders: 63, incentive: 530, overtime: 2, status: "present" },
    "2024-01-22": { punchIn: "9:18 AM", punchOut: "6:20 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 51, incentive: 410, overtime: null, status: "present" },
    "2024-01-24": { punchIn: "9:10 AM", punchOut: "6:15 PM", totalHours: 9, warehouse: "Downtown Hub", orders: 54, incentive: 440, overtime: null, status: "present" },
    "2024-01-25": { punchIn: "9:05 AM", punchOut: "8:10 PM", totalHours: 11, warehouse: "Downtown Hub", orders: 65, incentive: 550, overtime: 2, status: "present" },
  };
      ...
      <View style={styles.combinedStatusCard}>
        <View style={styles.combinedStatusLeft}>
          ...
          <View style={styles.topTimeRow}>
            ...
            <Text style={styles.topTimeText}>{startTime} – {endTime}</Text>
          </View>
